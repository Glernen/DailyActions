    ...
    for (const v of event["Message"].split("&")) {
      ...
      switch (TENCENTSCF_SOURCE_TYPE) {
        ...
        case 'git':
          ...
          request(`https://raw.githubusercontent.com/h455257166/My_Script/JSActionsScripts/${v}.js`, function (error, response, body) {
            eval(response.body)
          })
          break;
        case 'custom':
        ...
        default:
          ...
          request(`https://gitee.com/h455257166/My_Script/raw/JSActionsScripts/${v}.js`, function (error, response, body) {
            eval(response.body)
          })
          break;
      }
